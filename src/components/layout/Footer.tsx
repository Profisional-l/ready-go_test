    ...
    <footer id="contact" className="bg-foreground text-background py-12 md:py-16">
      <div className="max-w-[1440px] mx-auto px-8 grid md:grid-cols-2 gap-12 md:gap-8 items-start">
        <div className="space-y-6">
          <h3 className="text-2xl font-extrabold">READY <span className="text-accent">GO</span></h3>
          ...
          <div className="flex space-x-4">
            ...
            <Link href="mailto:hello@readygo.agency" aria-label="Email" className="text-muted-foreground hover:text-accent transition-colors">
              <Mail size={24} />
            </Link>
          </div>
        </div>
        ...
        <form action={handleSendMessage} className="space-y-4">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <Input 
              ...
              required 
              className="bg-background/5 border-background/20 placeholder:text-muted-foreground/70 text-background focus:border-accent focus:ring-accent"
            />
            <Input 
              type="email" 
              name="email"
