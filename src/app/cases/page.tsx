  ...
  return (
    <>
      ...
      <main className="bg-[#F1F0F0] md:bg-transparent text-foreground pb-[68px] casePageMain">
        <div
          id="cases-pb"
          className="max-w-[1640px] mx-auto px-4 md:px-9 py-16 md:py-24"
        >
          <h1
            className={`text-6xl md:text-[130px] font-mycustom text-foreground mt-14 mb:mt-0 mb-8 md:mb-1 uppercase  ${
              isSafariOrIOS ? "translate-y-6" : ""
            }`}
          >
            кейсы
          </h1>
        ...
        <div className="hidden md:block  self-end md:self-auto px-4 md:px-9 max-w-[1640px] md:mx-auto">
          <Button
            asChild
            variant="outline"
