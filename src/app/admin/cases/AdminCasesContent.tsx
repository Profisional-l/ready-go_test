...
import { addCaseAction, logoutAction } from './actions';
import { useRouter } from "next/navigation";

export default function AdminCasesContent() {
  ...
  const handleLogout = async () => {
    ...
    await logoutAction();
    // The page should automatically redirect due to the server component's logic,
    // but a router.refresh() can ensure client state is updated if needed.
    // router.refresh(); // Usually not needed as action redirects or revalidates path
  ...
  return (
    <div className="container mx-auto p-8">
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-3xl font-bold text-foreground">Админ: Добавить новый кейс (Локальное хранилище)</h1>
